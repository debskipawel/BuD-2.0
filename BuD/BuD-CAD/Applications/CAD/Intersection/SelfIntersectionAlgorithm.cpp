...
#include <Applications/CAD/Visitors/Intersection/CalculatorParameterShortestDistance.h>
	...
	: BaseIntersectionAlgorithm(parameters)
{
	...
	m_LoopDetectors.emplace_back(std::make_unique<ShortestDistanceLoopDetector>(m_ParameterizedObject, m_ParameterizedObject, m_Parameters.m_PointDistance));
