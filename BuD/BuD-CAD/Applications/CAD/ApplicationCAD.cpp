...
#include <Applications/CAD/Behaviors/Mouse/MainMouseBehaviorLayerCAD.h>
#include <Applications/CAD/Behaviors/Keyboard/MainKeyboardBehaviorLayerCAD.h>

#include <Applications/CAD/GUI/MainGuiLayerCAD.h>

ApplicationCAD::ApplicationCAD()
	: m_MainDataLayer()
{
	m_GuiLayer = std::make_unique<MainGuiLayerCAD>(m_MainDataLayer);

	m_MouseBehaviorLayer = std::make_unique<MainMouseBehaviorLayerCAD>(m_MainDataLayer);
	m_KeyboardBehaviorLayer = std::make_unique<MainKeyboardBehaviorLayerCAD>(m_MainDataLayer);
}
