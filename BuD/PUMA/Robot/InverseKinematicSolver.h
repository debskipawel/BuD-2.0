...
protected:
	...
	virtual auto GetAnglesFromJoints(const RobotParameters& robotParameters, const Frame& baseFrame, const Frame& effectorFrame, std::array<dxm::Vector3, 5> joints, const std::optional<RobotConfiguration> referenceConfiguration = std::nullopt) -> RobotConfiguration;
};
